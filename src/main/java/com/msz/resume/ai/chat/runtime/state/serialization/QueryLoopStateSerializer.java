...
/**
 * QueryLoopState 状态序列化器。
 *
 * 用于 AskUserQuestion 挂起会话时将内层状态序列化到 Redis，
 * 支持将 LangChain4j 消息对象与可序列化 Map 之间的双向转换。
 */
public class QueryLoopStateSerializer extends StateSerializer<QueryLoopState> {

    public QueryLoopStateSerializer() {
        super(QueryLoopState::new);
    }
